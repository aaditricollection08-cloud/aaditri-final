        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          <div className="md:col-span-2">
            <Link href="/" className="inline-block mb-6">
              <span className="font-serif text-2xl font-bold">Aaditri Collection</span>
            </Link>
            <p className="text-background/70 leading-relaxed mb-6 max-w-md">
              {"Kolkata's trusted wholesaler of premium nightwear, cotton nighties, kaftans, and bedsheet sets. Serving retailers across India since 2015."}
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link href="#why-us" className="text-background/70 hover:text-background transition-colors">
                  Why Choose Us
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-background/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-background/60 text-sm">
              © {new Date().getFullYear()} Aaditri Collection. All rights reserved.
            </p>
